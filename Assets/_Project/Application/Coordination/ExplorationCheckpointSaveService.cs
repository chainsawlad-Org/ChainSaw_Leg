...
namespace ChainSawLeg.Features.Exploration.Save
{
    public sealed class ExplorationCheckpointSaveService : IDisposable
    {
        ...
        private async UniTask SaveToSlotCoreAsync(
            ...
            CancellationToken cancellationToken)
        {
            string previousSceneId = saveContextService.SceneId;
            string previousCheckpointId = saveContextService.CheckpointId;
            ...
            {
                saveContextService.SetContext(previousSceneId, previousCheckpointId);
                throw;
            }
        }
