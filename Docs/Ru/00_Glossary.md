...
Все архитектурные документы, комментарии и обсуждения должны использовать определения, приведенные здесь.
...
Создается при загрузке сцены и уничтожается при ее выгрузке.
