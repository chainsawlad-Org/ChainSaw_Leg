...
Ее задача — подготовить окружение для работы игры и передать управление первой игровой фазе.
...
После завершения ReplaceMain() Bootstrap считается полностью завершенным.
...
Bootstrap не создает зависимости самостоятельно.
